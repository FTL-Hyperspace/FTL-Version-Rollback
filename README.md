...
A collection of patches used to rollback FTL: Faster Than Light to a version supported by [FTL Hyperspace](https://github.com/FTL-Hyperspace/FTL-Hyperspace)

## Supported rollbacks

**Windows**: 1.6.14, 1.6.22 -> 1.6.9
